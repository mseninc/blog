---
title: "[FortiGate] ユーザー登録 & SSL VPN の二要素認証メールアドレス登録をマクロ化する"
date: 
author: hiratatsu04
tags: [FortiGate]
...
そこで、今回は **「ユーザー登録 & 二要素認証のメールアドレス登録」をバッチ処理してくれるマクロ** を作成しましたので紹介します。
...
今回は、「ユーザー登録 & 二要素認証のメールアドレス登録」をバッチ処理してくれるマクロを紹介しました。
