...
![AWS コンソール IAM → ユーザー](images/2022-02-22_22h27_22.png)

アクセスキーを作成するユーザーを選択します。

![AWS コンソール IAM → ユーザー → ユーザーの選択](images/2022-02-22_22h34_33.png)

「認証情報」タブにある「アクセスキーの作成」からアクセスキーを作成することができます。

![AWS コンソール IAM → ユーザー → 認証情報 → アクセスキーの作成](images/2022-02-22_22h42_12.png)

シークレットキーを表示できるのは作成時のみなので、 csv ファイルをダウンロードしておくと安心です（アクセスキー自体はいつでも作成し直せます）。

![AWS コンソール IAM → ユーザー → 認証情報 → アクセスキーの作成 → csv ダウンロード](images/2022-02-22_22h46_01.png)
