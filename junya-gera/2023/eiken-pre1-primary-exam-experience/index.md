...
過去に英検 2 級に合格していて、準1級は初めての挑戦でした。
...
このような形になることは想定通りでしたが、自分で思っていたよりも**ライティングでの減点が多かったこと**が誤算でした。
...
ただ、 TOEIC や英検準 2 級とは異なり、大問 1 は**文法問題は出題されず、全て語彙問題**となっています。

出題されうる単語数がとても多いですが、しっかりと暗記することができれば高得点を狙えます。
...
問題が表示される際に英語音声も流れるため、発音も一緒に覚えることが可能なので、リスニング対策にもなります。
...
また、これは TOEIC でも同じですが、家でイヤホンで聴いているときと違い、**広い部屋でスピーカーから流れる英文は響くのでとても聞き取りづらく感じました**。
...
Part3 は TOEIC や英検準 2 級にはない形式で、問題ごとに Situation と Question が問題用紙に記載されていて、音声が流れる前に 10 秒間それらを読む時間が与えられます。

その後、流れる音声を聴き、 Question に対する回答を 4 択から選びます。

こちらは問題文が問題用紙に記載されているため、 Part1、2 と比べると易しいです。
...
どちらも音声を聴きながらそれを真似て声に出す練習を行いました。ただ、今回はまだ練習が足りなかったのか点数には結びつきませんでした。一朝一夕ではいかなさそうです。
...
単語に関しては引き続き英語漬けを利用します。 3000 語を定着させ続けることは大変なので、ひたすら反復を続けます。
...
また、別の書き換えが思いつかずつい同じ表現を繰り返してしまうことが多いので、語彙を増やしたり、同じ意味で違う書き方 (for example と for instance など) をもっとインプットします。
...
原因はリスニングであることはわかっているので、しっかり練習を続けていきます。
