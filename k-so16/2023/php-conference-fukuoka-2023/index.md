...
Web UI のテストが書かれない理由として、 **すぐ壊れる** という理由が挙げられます。テストがすぐ壊れる理由として、 *UI の変更の多さ* が考えられます。しかし、ユーザーが変更前と同様に使い続けられるにもかかわらず、テストが壊れてしまうのは、そのテストが **本番の再現からかけ離れている** のではないかということでした。
