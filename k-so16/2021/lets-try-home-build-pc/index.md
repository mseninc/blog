...
1. ケースにマザーボードを取り付ける
    ...
    ![六角スペーサーの位置 (○ 部分)](images/lets-try-home-build-pc-1.jpg "六角スペーサーの位置 (○ 部分)")
...
1. CPU を取り付ける
    ...
    ![CPU ソケットの位置 (□ 部分)](images/lets-try-home-build-pc-2.jpg "CPU ソケットの位置 (□ 部分)")
...
1. メモリを取り付ける
    ...
    ![メモリスロットの位置 (□ 部分)](images/lets-try-home-build-pc-3.jpg "メモリスロットの位置 (□ 部分)")
    ...
    ![CPU とメモリを差し込んだ状態](images/lets-try-home-build-pc-4.jpg "CPU とメモリを差し込んだ状態")

1. CPU ファンを取り付ける

    CPU とメモリを取り付けたら、 CPU ファンを取り付けます。 **CPU に付属しているファン** の場合、 **CPU の説明書** を、 **CPU ファンを別で購入** した場合は **付属の説明書** に従って取り付けます。

    ![CPU ファンの取り付け後](images/lets-try-home-build-pc-5.jpg "CPU ファンの取り付け後")
...
1. 電源やケースの配線をする
    ...
    ![電源ユニットとケースの配線後](images/lets-try-home-build-pc-6.jpg "電源ユニットとケースの配線後")
