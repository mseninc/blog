...
`description` | 記事の説明を記述<br>記事一覧ページなどに要約として表示される
...
![](.github/readme/images/image-caption.png)
...
- [表示されているテキストとaltが同一の場合 | ウェブアクセシビリティ基盤委員会（WAIC）](https://waic.jp/qa/redundant-alt-with-caption/)
