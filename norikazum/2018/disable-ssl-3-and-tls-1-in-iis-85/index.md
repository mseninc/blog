...
<img src="images/disable-ssl-3-and-tls-1-in-iis-85-1.png" alt="" width="1450" height="806" class="alignnone size-full wp-image-8222" />

結果を確認すると、SSL 3.0 と TLS 1.0 が有効(Yes)になっていることが分かりました。
<img src="images/disable-ssl-3-and-tls-1-in-iis-85-2.png" alt="" width="1194" height="296" class="alignnone size-full wp-image-8223" />
...
[新規→キーから作成]
<img src="images/disable-ssl-3-and-tls-1-in-iis-85-3.png" alt="" width="445" height="398" class="alignnone size-full wp-image-8224" />

そして、さらにそれぞれの下に、 **Server** というキーを作成します。
こうなるわけですね。

<img src="images/disable-ssl-3-and-tls-1-in-iis-85-4.png" alt="" width="210" height="200" class="alignnone size-full wp-image-8227" />
...
<img src="images/disable-ssl-3-and-tls-1-in-iis-85-5.png" alt="" width="632" height="197" class="alignnone size-full wp-image-8228" />
...
<img src="images/disable-ssl-3-and-tls-1-in-iis-85-6.png" alt="" width="1450" height="806" class="alignnone size-full wp-image-8230" />

判定が　**B** に上がり、SSL3.0 と TLS 1.0　が無事無効になりました。
<img src="images/disable-ssl-3-and-tls-1-in-iis-85-7.png" alt="" width="1450" height="806" class="alignnone size-full wp-image-8231" />

<img src="images/disable-ssl-3-and-tls-1-in-iis-85-8.png" alt="" width="1174" height="256" class="alignnone size-full wp-image-8232" />
